...
public class NewUserRegistration {
	...
	{   ApcoaListeners.logInfo("AddVehicle Started:");
		...
		{	if(AutomationConfiguration.Environment.equalsIgnoreCase("Staging"))
			{ btnNext2.click();
	...
	{   ApcoaListeners.logInfo("Going to Payment_Card");
	   if(!(AutomationConfiguration.Country.equalsIgnoreCase("Sweden")||AutomationConfiguration.Country.equalsIgnoreCase("Denmark")||AutomationConfiguration.Environment.equalsIgnoreCase("Production")))
	   {Thread.sleep(4000);
	    btnVisa.click();
	    Thread.sleep(3000);
